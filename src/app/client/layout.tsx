...
import { FileText, PlusCircle, Settings, LogOut, ChevronRight, MapPin } from 'lucide-react'
        ...
        {NAV.map(({ href, label, icon: Icon, exact }) => {
          ...
          return (
            <Link
              ...
              style={active ? {
                background: 'linear-gradient(135deg, rgba(14,165,233,0.14) 0%, rgba(37,99,235,0.06) 100%)',
            ...
            >
              ...
              >
                <Icon className="w-3.5 h-3.5" style={{ color: active ? '#38BDF8' : 'rgba(255,255,255,0.32)' }} />
              </div>
              <span className="flex-1">{label}</span>
              {active && <ChevronRight className="w-3.5 h-3.5" style={{ color: 'rgba(56,189,248,0.45)' }} />}
            </Link>
          )
        })}
      </nav>
        ...
        {user && (
          ...
          >
            <div
              ...
              style={{
                background: 'linear-gradient(135deg, rgba(14,165,233,0.32), rgba(37,99,235,0.2))',
                color: '#38BDF8',
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[10px] truncate" style={{ color: 'rgba(255,255,255,0.28)' }}>Compte client</div>
            </div>
          </div>
        )}
        <button
